...
public class HelperVi extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase database) {
        ...
        database.execSQL(" insert into "+TABLE_BODEGA+"(nombodega) values(('Bodega1'))");
        database.execSQL(" insert into "+TABLE_BODEGA+"(nombodega) values(('Bodega2'))");
        database.execSQL(DATABASE_CREATE_DENOMINACIO);
        database.execSQL(" insert into "+TABLE_DENOMINACIO+"(nomdenominacio) values(('Denominacio'))");
        database.execSQL(" insert into "+TABLE_DENOMINACIO+"(nomdenominacio) values(('Den2'))");
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        Log.w(HelperVi.class.getName(),"Modificant desde la versió " + oldVersion + " a "+ newVersion );
